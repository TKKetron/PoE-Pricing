namespace POE_Pricing
{
    partial class HarvestMemoryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelHostProfit = new Label();
            labelPerPlayerProfit = new Label();
            labelHostProfitOutput = new Label();
            ...
            // labelHostProfit
            // 
            labelHostProfit.AutoSize = true;
            labelHostProfit.Location = new Point(330, 23);
            labelHostProfit.Name = "labelHostProfit";
            labelHostProfit.Size = new Size(64, 15);
            labelHostProfit.TabIndex = 10;
            labelHostProfit.Text = "Host Profit";
            // 
            // labelPerPlayerProfit
            // 
            labelPerPlayerProfit.AutoSize = true;
            labelPerPlayerProfit.Location = new Point(330, 98);
            labelPerPlayerProfit.Name = "labelPerPlayerProfit";
            labelPerPlayerProfit.Size = new Size(91, 15);
            labelPerPlayerProfit.TabIndex = 11;
            labelPerPlayerProfit.Text = "Per Player Profit";
            // 
            // labelHostProfitOutput
            // 
            labelHostProfitOutput.BackColor = SystemColors.Window;
            labelHostProfitOutput.BorderStyle = BorderStyle.FixedSingle;
            labelHostProfitOutput.Location = new Point(330, 44);
            labelHostProfitOutput.Name = "labelHostProfitOutput";
            labelHostProfitOutput.Size = new Size(100, 23);
            labelHostProfitOutput.TabIndex = 12;
            labelHostProfitOutput.Text = "0.00";
            labelHostProfitOutput.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelPerPlayerProfitOutput
            // 
            labelPerPlayerProfitOutput.BackColor = SystemColors.Window;
            labelPerPlayerProfitOutput.BorderStyle = BorderStyle.FixedSingle;
            labelPerPlayerProfitOutput.Location = new Point(330, 119);
            labelPerPlayerProfitOutput.Margin = new Padding(3);
            labelPerPlayerProfitOutput.Name = "labelPerPlayerProfitOutput";
            labelPerPlayerProfitOutput.Size = new Size(100, 23);
            labelPerPlayerProfitOutput.TabIndex = 13;
            labelPerPlayerProfitOutput.Text = "0.00";
            labelPerPlayerProfitOutput.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // contextMenuStrip1
            // 
            ...
            panelHarvest.Controls.Add(labelTotalProfitOutput);
            panelHarvest.Controls.Add(labelTotalProfit);
            panelHarvest.Controls.Add(labelPlayerProfitOutput);
            panelHarvest.Controls.Add(labelPlayerProfit);
            panelHarvest.Controls.Add(checkBoxVividVulture);
            panelHarvest.Controls.Add(checkBoxPrimalCrushclaw);
            panelHarvest.Controls.Add(labelPerPlayerProfitOutput);
            panelHarvest.Controls.Add(checkBoxPrimalCystcaller);
            panelHarvest.Controls.Add(labelHostProfitOutput);
            panelHarvest.Controls.Add(checkBoxPrimalRhexMatriarch);
            panelHarvest.Controls.Add(labelPerPlayerProfit);
            panelHarvest.Controls.Add(checkBoxWildBrambleback);
            panelHarvest.Controls.Add(labelHostProfit);
            ...
            // 
            labelTotalProfitOutput.BackColor = SystemColors.Window;
            labelTotalProfitOutput.BorderStyle = BorderStyle.FixedSingle;
            labelTotalProfitOutput.Location = new Point(330, 269);
            labelTotalProfitOutput.Margin = new Padding(3);
            labelTotalProfitOutput.Name = "labelTotalProfitOutput";
            labelTotalProfitOutput.Size = new Size(100, 23);
            labelTotalProfitOutput.TabIndex = 17;
            labelTotalProfitOutput.Text = "0.00";
            labelTotalProfitOutput.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelTotalProfit
            // 
            labelTotalProfit.AutoSize = true;
            labelTotalProfit.Location = new Point(330, 248);
            labelTotalProfit.Name = "labelTotalProfit";
            labelTotalProfit.Size = new Size(64, 15);
        ...
        private Label labelHostProfit;
        private Label labelPerPlayerProfit;
        private Label labelHostProfitOutput;
        private Label labelPerPlayerProfitOutput;
        private ContextMenuStrip contextMenuStrip1;
        private Panel panelHarvest;
        private Label labelPlayerProfitOutput;
        private Label labelPlayerProfit;
        private NumericUpDown numericUpDownExtraPlayers;
        private Label labelTotalProfitOutput;
